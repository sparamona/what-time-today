...
export function copyToClipboard(e, id, output, timeZones, messageType, AMPM, MonthDay) {
    ...
    myFluffyTextarea.innerHTML = outputToStringCopy(output, timeZones, messageType, AMPM, MonthDay);
